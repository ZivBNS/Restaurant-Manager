...
public class User_Session {
    private static Subscribed_Customer loggedInUser = null; // For Subscribers/Employees
    private static String casualPhone = null; // For Casual Customers
    private static String casualEmail = null; // For Casual Customers

    public static void setLoggedInUser(Subscribed_Customer user) { loggedInUser = user; }
    public static Subscribed_Customer getLoggedInUser() { return loggedInUser; }
